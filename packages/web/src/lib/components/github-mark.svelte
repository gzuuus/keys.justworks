<script lang="ts">
	// GitHub's octocat mark as an inline SVG — lucide removed brand icons, so
	// there's no icon to import. Path from simple-icons (CC0); fill follows
	// `currentColor` so it sits in the text color scheme like the lucide icons.
